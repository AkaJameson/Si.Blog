...
{
    internal class CaptchaGenerater
    {
        ...
        public CaptchaGenerater()
        {
            ...
            // 加载嵌入的资源图像
            string imagePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Captcha.png");
        ...
        // 生成验证码图片并返回相关参数
        public CaptchaRecord GetCaptcha(TimeSpan expiratime, int length = 4)
        {
            int width = 300;
            int height = 100;
            ...
            using (SKCanvas canvas = new SKCanvas(bitmap))
            {
                ...
                using (MemoryStream ms = new MemoryStream())
                {
                    ...
                    return new CaptchaRecord
                    {
                        ...
                        CaptchaImage = ms.ToArray(),
                        ExpiraTime = DateTime.Now.Add(expiratime)
                    };
                }
            }
        }
